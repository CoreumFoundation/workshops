            ...
            <div>
                <Menu.Button className="inline-flex w-full justify-center items-center rounded-3xl bg-gradient-green-card-button px-3 py-2 text-sm font-medium text-[#25D695] ring-0">
                    ...
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.3714 12.6823C10.1727 12.903 9.8267 12.903 9.62807 12.6823L5.6079 8.21541C5.31831 7.89365 5.54666 7.38093 5.97955 7.38093H14.0199C14.4528 7.38093 14.6811 7.89365 14.3915 8.21541L10.3714 12.6823Z" fill="#25D695"/>
                    </svg>
                </Menu.Button>
            </div>
            <Transition
                            ...
                            return (
                                <Menu.Item key={`dropdown-${index}`}>
                                    {dropdownItem.type !== 'link' ? (
                                        ...
                                        >
                                            <DropdownIcon className="mr-2" type={dropdownItem.icon} /> {dropdownItem.label}
                                        </div>
                                    ) : (
                                        <a
