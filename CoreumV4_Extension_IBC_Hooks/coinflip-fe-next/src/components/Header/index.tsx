...
export const Header = () => {
  ...
  const handleCopyAddress = React.useCallback(() => {
    ...
    tempTextArea.value = chainContext.address;
  ...
  const renderConnectWallet = React.useMemo(() => {
    return (
      <div
        ...
        className="relative bg-[#25b97b] flex items-center justify-center font-semibold bg-gradient-teal py-2 px-2 sm:px-5 rounded text-sm cursor-pointer"
      >
        <svg
          width="17"
          height="18"
  ...
  return (
    <div className="flex justify-between items-center w-full py-4 md:py-10 px-4 md:px-16 lg:px-32">
      <Link href="/">
        <img
          className="w-36 sm:w-44 md:w-48 rounded-none"
          src="/coreum-logo.png"
          width={180}
          height={36}
          loading="lazy"
